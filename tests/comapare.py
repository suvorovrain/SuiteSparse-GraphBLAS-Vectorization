...
def compare_files(directories, num_files=5):
    for file_index in range(num_files):
        file_name = f'res_{file_index}.txt'
        file_paths = [os.path.join(directory, file_name) for directory in directories]
...
compare_files(directories, num_files=5)